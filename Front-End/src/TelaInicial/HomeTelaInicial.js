...
function HomeTelaInicial() {
  useEffect(() => {
    ...
    const scrollFadeEls = root
      ? Array.from(root.querySelectorAll(".scroll-fade"))
      : [];
    ...
    // Carrossel
    const items = root
      ? Array.from(root.querySelectorAll(".carossel-item"))
      : [];
    ...
    <div className="tela-inicial">
        ...
        <div className="hero-textos" id="secao-hero-texto">
          <div className="frase-um fade-in delay-1">
            <div className="p1">
              <h2>Simplifique</h2>
              <br />
              <span>Emissão automática de notas fiscais</span> e boletos.
              <br />
            </div>
            <p className="p2">
              Soluções integradas com bancos e plataformas
              <br />
      ...
      <section className="secao-video" id="funcionalidades">
        <div className="conteudo-video scroll-fade">
          <h2>
            A FINC te permite emitir notas com <br /> os{" "}
            <span>recursos essenciais</span> que melhoram <br /> a performance
            do seu negócio
          </h2>
          <hr className="linha" />
          <div className="print scroll-fade delay-1">
            ...
            <a
              href="https://drive.google.com/file/d/1Kc2OVb9b1q8j8dSnsXDZ7HlbiD-3HFf5/view?usp=sharing"
              target="_blank"
      ...
      <section className="secao-destaque">
        ...
        <div className="lado-direito scroll-fade delay-1">
          ...
          <p>
            Com o sistema FINC você automatiza tarefas, como emissão de notas
            fiscais, controle fiscal, gestão financeira e dashboards
            inteligentes, conectando todas as informações ao seu e-commerce ou
            loja física.
          </p>
          <Link to="/TelaInicial/Login">
            <p className="botao-destaque scroll-fade delay-2">Comece agora</p>
          </Link>
        </div>
      </section>
      ...
      <section className="secao-carrossel">
        <section className="form-section">
          ...
          <p className="scroll-fade delay-2">
            Dados que são utilizados para agilizar a emissão manual no plano
            BÁSICO.
          </p>
        </section>
        ...
        <section className="carossel scroll-fade delay-3">
          ...
          <div className="carossel-container">
            <img
              src="/Images/print-dados.png"
              className="carossel-item active"
              alt="Meus dados"
            />
            <img
              src="/Images/print-clientes.png"
              className="carossel-item"
              alt="Meus clientes"
            />
          </div>
        ...
        <div className="conteudo-sobre">
          ...
          <div className="lado-direito scroll-fade delay-1">
            <div className="texto-sobre">
              <p>
                A <span className="bold">finc</span> surgiu com o intuito de ser
              </p>
              <p>
                uma plataforma <span className="bold">acessível</span>, que
              </p>
        ...
        <div className="conteudo-app">
          <div className="texto-app scroll-fade">
            ...
            <div className="botoes-app scroll-fade delay-1">
              <a
                href="https://play.google.com/store/apps?hl=pt_BR&pli=1"
                target="_blank"
                rel="noopener noreferrer"
              >
